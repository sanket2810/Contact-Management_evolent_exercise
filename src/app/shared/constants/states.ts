export const STATES = {
  CANADA: [
    ...
    {country: 'CA', code: 'NL', name: 'Newfoundland'},
    ...
    {country: 'CA', code: 'YT', name: 'Yukon Territory'}
  ],
  US: [
    {country: 'US', code: 'AA', name: 'Armed Forces Americas'},
    {country: 'US', code: 'AE', name: 'Armed Forces Europe, Middle East, & Canada'},
    ...
    {country: 'US', code: 'FM', name: 'Federated States of Micronesia'},
    ...
    {country: 'US', code: 'MP', name: 'Northern Mariana Islands'},
    ...
    {country: 'US', code: 'VI', name: 'Virgin Islands'},
